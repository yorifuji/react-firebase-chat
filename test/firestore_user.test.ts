...
describe("作成", () => {
  ...
  test("成功", async () => {
    ...
    // test
    await testing.assertSucceeds(firestore.doc("users/alice").set({
      owner: "alice",
      name: "ALICE",
  ...
  test("失敗（未認証）", async () => {
    ...
    const firestore = ctx.firestore()
    // test
    await testing.assertFails(firestore.doc("users/alice").set({
      owner: "alice",
      name: "ALICE",
      createdAt: serverTimestamp(),
      updatedAt: serverTimestamp()
...
describe("更新", () => {
  ...
  test("成功", async () => {
    ...
    await testing.assertSucceeds(ref.update({
      owner: "alice",
      name: "ALICE-updated",
      updatedAt: serverTimestamp()
    }))
  ...
  test("失敗（未認証）", async () => {
    ...
    // test
    const ref = firestore.doc("users/alice")
    await testing.assertFails(ref.update({
      owner: "alice",
      name: "ALICE-updated",
      updatedAt: serverTimestamp()
    }))
